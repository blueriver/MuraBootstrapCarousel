...
<cfscript>
	...
	if ( not isArray(params.exampleParam)){
		params.exampleParam=[params.exampleParam];
	}
</cfscript>
<cfoutput>
	<div id="availableObjectParams"	
		...
		<dl class="singleColumn">
			...
			<cfloop from="1" to="#arrayLen(params.exampleParam)#" index="i">
			<dd><input name="exampleParam" class="objectParam" value="#HTMLEditFormat(params.exampleParam[i])#"/></dd>
			</cfloop>
		</dl>			
	</div>			
</cfoutput>